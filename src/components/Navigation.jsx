...
export default function Navigation(){
    return (
        <div className='flex justify-between items-center m-2 '>
            ...
            <nav className=' mr-7 bg-black sm:basis-2/3  font-ubuntu font-semibold text-slate-100 shadow-sm shadow-slate-500 rounded-md hidden p-4 capitalize sm:block '>
